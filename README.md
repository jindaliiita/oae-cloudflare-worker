...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/adobe/oae-cloudflare-worker)
...
**Cloudflare Dashboard → Workers & Pages → `adobe-oae-worker` → Settings → Variables and Secrets**
...
Go to **Workers & Pages → `adobe-oae-worker` → Triggers → Routes**
...
**Cloudflare Dashboard → Workers & Pages → `adobe-oae-worker` → Triggers → Routes**
